      ...
      <ul className={styles.list}>
        <li className={styles.item}>
          ...
          <p className={styles.text_card}>
            ...
            достигать своих целей, объединяясь с другими, и с помощью полученных
            знаний и инструментов строить своё будущее.
          </p>
        </li>
        <li className={styles.item}>
          ...
          <p className={styles.text_card}>
            Дать людям возможность получения знаний и заработка в разных сферах
            деятельности с помощью различных инструментов.
          </p>
        </li>
        <li className={styles.item}>
